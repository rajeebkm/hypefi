...
import { AvailableSaveloadVersions, ResolutionString } from "~~/public/static/charting_library/charting_library";
...
export const widgetOptionsDefault = {
  ...
  charts_storage_api_version: TRADING_VIEW_DEFAULTS.CHARTS_STORAGE_API_VERSION as AvailableSaveloadVersions,
